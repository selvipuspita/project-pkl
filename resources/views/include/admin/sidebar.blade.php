<aside class="main-sidebar sidebar-light-primary elevation-4">
    <!-- Brand Logo -->
    <a href="{{ route('DashboardAdmin') }}" :active="request()->routeIs('DashboardAdmin')" class="brand-link">
        <img src="{{asset('img/logonya.png')}}" alt="UIN Bandung"
            class="brand-image img-circle elevation-3" style="opacity: .8">
        <span class="brand-text font-weight-light">ADMIN UINSGD</span>
    </a>
    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               <li class="nav-item">
                    <a href="{{ route('DashboardAdmin') }}" :active="request()->routeIs('DashboardAdmin')" class="nav-link">
